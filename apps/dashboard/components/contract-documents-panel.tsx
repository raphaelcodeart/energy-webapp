          ...
          >
            <div className="flex items-center justify-between gap-3 flex-wrap">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                />
                {/* A second picker that goes straight to the camera (Session 55):
                    a customer or promoter at a kitchen table photographs the
                    identity card or the bill instead of hunting for a scan.
                    On a computer the browser simply opens the file picker. */}
                <input
                  type="file"
                ...
                <label
                  ...
                  className="px-2.5 py-1 rounded-lg bg-white/5 light:bg-slate-900/5 hover:bg-white/10 border border-white/10 light:border-slate-300 text-slate-300 light:text-slate-600 text-xs font-semibold cursor-pointer transition inline-flex items-center gap-1"
                >
        ...
        {addingExtra ? (
          <div className="mt-2 p-3 rounded-xl bg-white/5 light:bg-slate-900/5 border border-orange-500/20 space-y-2">
            ...
            <p className="text-[10px] text-slate-500">
              Scrivi cos&apos;è, così l&apos;amministrazione sa cosa sta verificando. PDF, JPG o PNG, massimo 15 MB, oppure scatta una foto.
            </p>
            <input
              ref={extraFileInput}
              type="file"
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={!canPickExtraFile || uploadingType === "OTHER"}
                className="px-3 py-1.5 rounded-lg bg-white/5 light:bg-slate-900/5 hover:bg-white/10 border border-white/10 light:border-slate-300 text-slate-300 light:text-slate-600 text-xs font-semibold transition cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
              >
                Scatta una foto
              </button>
              <button
