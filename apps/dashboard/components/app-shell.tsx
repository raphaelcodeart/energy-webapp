...
const NOTIFICATION_TYPE_LABELS: Record<string, string> = {
  ...
  SHOPIFY_ORDER_CREATED: "Nuovo ordine Shopify",
  SHOPIFY_ORDER_PAID: "Ordine Shopify pagato",
  SHOPIFY_ORDER_FAILED: "Ordine Shopify da controllare",
