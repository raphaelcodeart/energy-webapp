                    ...
                    <tr className="bg-white/2 light:bg-slate-900/[0.02]">
                      <td colSpan={6} className="px-5 py-4 text-xs space-y-1.5">
                        ...
                        {(t.reference_order_id || t.reference_imported_order_id || t.reference_cj_order_id || t.reference_shopify_order_id) && (
                          <p><span className="text-slate-500">Ordine collegato:</span> <span className="font-mono text-[10px] text-slate-300 light:text-slate-600">{t.reference_order_id ?? t.reference_imported_order_id ?? t.reference_cj_order_id ?? t.reference_shopify_order_id}</span> <span className="text-slate-600">(vedi Ordini)</span></p>
                        )}
